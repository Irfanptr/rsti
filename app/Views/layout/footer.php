  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="https://rstuguibu.com">Rumah Sakit Tugu Ibu</a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<!-- SlimScroll -->
<script src="<?php base_url() ?>/template/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?php base_url() ?>/template/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
